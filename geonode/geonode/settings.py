...
_DEFAULT_LOCALE_PATHS = (os.path.join(PROJECT_ROOT, "locale"),)
...
MARKDOWNIFY = {"default": {"WHITELIST_TAGS": os.getenv("MARKDOWNIFY_WHITELIST_TAGS", markdown_white_listed_tags)}}
...
PINAX_RATINGS_CATEGORY_CHOICES = {
    ...
    "layers.Dataset": {"dataset": "How good is this dataset?"},
    "documents.Document": {"document": "How good is this document?"},
    "geoapps.GeoApp": {"geoapp": "How good is this geoapp?"},
}
...
GEOSERVER_PUBLIC_SCHEMA = os.getenv("GEOSERVER_PUBLIC_SCHEMA", SITE_HOST_SCHEMA)
...
GEOSERVER_ADMIN_PASSWORD = os.getenv("GEOSERVER_ADMIN_PASSWORD", "CFOq3rrLK3mz6oS")
...
# GEOSERVER_FACTORY_PASSWORD = os.getenv("GEOSERVER_ADMIN_PASSWORD", "geoserver")
...
DEFAULT_MAX_UPLOAD_SIZE = 943718400  # 900 MB
...
# --- CORREÇÃO: SYSTEM_HANDLERS já são carregados automaticamente pelo apps.py ---
# Removido para evitar duplicação de handlers
