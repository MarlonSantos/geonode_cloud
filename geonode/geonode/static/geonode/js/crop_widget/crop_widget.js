...
class DomBuilder {
    ...
    _create_flow_buttons() {
        ...
        this.grain_wrapper.append(`<label id=${IDS_VALUT.FILE_LABEL_ID} for=${IDS_VALUT.FILE_INPUT_ID} class="btn btn-default crop-input-label">${gettext('Choose file')}</label>`);
        this.grain_wrapper.append(`<button type=button id=${IDS_VALUT.SEND_B_ID} class=\"btn btn-default invisible\">${gettext('Save')}</button><button type=button id=${IDS_VALUT.CANCEL_B_ID} class="btn btn-default invisible">${gettext('Cancel')}</button>`);
    ...
    create_workspace() {
        const workspace_html = `
                              <div id=${IDS_VALUT.WORKSPACE_CONTAINER_ID} class="crop-modal-container invisible">                                  
                                  ...
                                  <button type=button id=${IDS_VALUT.OK_B_ID} class="btn btn-default">${gettext('OK')}</button><button type=button id=${IDS_VALUT.DISMISS_B_ID} class="btn btn-default">${gettext('Dismiss')}</button>                                      
                              </div>`;
