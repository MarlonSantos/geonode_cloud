...
var DomBuilder = /*#__PURE__*/function () {
  ...
  _createClass(DomBuilder, [{
    ...
    value: function _create_flow_buttons() {
      ...
      this.grain_wrapper.append("<label id=".concat(IDS_VALUT.FILE_LABEL_ID, " for=").concat(IDS_VALUT.FILE_INPUT_ID, " class=\"btn btn-default crop-input-label\">").concat(gettext('Choose file'), "</label>"));
      this.grain_wrapper.append("<button type=button id=".concat(IDS_VALUT.SEND_B_ID, " class=\"btn btn-default invisible\">").concat(gettext('Save'), "</button><button type=button id=").concat(IDS_VALUT.CANCEL_B_ID, " class=\"btn btn-default invisible\">").concat(gettext('Cancel'), "</button>"));
    }
  }, {
    key: "create_workspace",
    value: function create_workspace() {
      var workspace_html = "\n                              <div id=".concat(IDS_VALUT.WORKSPACE_CONTAINER_ID, " class=\"crop-modal-container invisible\">                                  \n                                  <img id=").concat(IDS_VALUT.WORKSPACE_ID, " class=\"crop-modal-workspace\">                                      \n                                  <button type=button id=").concat(IDS_VALUT.OK_B_ID, " class=\"btn btn-default\">").concat(gettext('OK'), "</button><button type=button id=").concat(IDS_VALUT.DISMISS_B_ID, " class=\"btn btn-default\">").concat(gettext('Dismiss'), "</button>                                      \n                              </div>");
